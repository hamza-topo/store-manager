...
<title>@lang('Edit Employer')</title>
@section('css')
...
<li class="breadcrumb-item active">@lang('lang.Edit Employer')</li>
@endsection
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">@lang('Employer Account')</h5>
                    </div>
                    <div class="card-body o-hidden">
                        <livewire:employer.employer-form :employerIdUpdated='$employer->id' />
                    </div>
                </div>
            </div>
            <div class="col-md-2"></div>
